      ...
      <VStack spacing={6} align="stretch">
        <Card>
          <CardBody>
            ...
            <Text color="gray.600">
              Passionate educator with 10+ years of experience in AI and Machine Learning.
            </Text>
          </CardBody>
        </Card>
            ...
            <Flex>
              <Box flex="1" mr={4}>
                <VStack spacing={4}>
                  ...
                  <MetricBar label="Assignment Grading Efficiency" value={98} />
                </VStack>
              </Box>
              <Box flex="1">
                <VStack spacing={4}>
                  ...
                  <StatCard
                    ...
                    value="2.3 hours"
                  />
                  <StatCard icon={FaChartBar} title="Leaderboard Rank" value="#7" />
                </VStack>
              </Box>
            </Flex>
          </CardBody>
